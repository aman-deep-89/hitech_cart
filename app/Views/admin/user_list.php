...
<div class="row">          
            ...
            <div class="col-xl-12 col-md-12 mb-4">            
                ...
                <div class="card-body">
                    <?php 
                    if(is_array($data['user_list']) && sizeof($data['user_list'])) {
                        $i=1; ?>
                        <table class="table">
                            <thead><tr><th>Sr No.</th><th>Username</th><th>Email</th><th>Active</th><th>Total Forecast</th></tr></thead>
                        <?php 
                        foreach($data['user_list'] as $user) { ?>
                            <tr><td><?= $i ?></td><td><?= $user->username ?></td><td><?= $user->email ?></td><td><?= $user->active ?></td><td>-</td></tr>                                              
                        <?php $i++; }  ?>                        
                    </table>
                    <?php }  else { ?>                    
                        No log found
