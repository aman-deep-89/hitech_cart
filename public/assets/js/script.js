        ...
        //tx.executeSql('SELECT *FROM STORE',[],function(ts,data) {
          //  store_name=data.rows.item(0).store_name;
            tx.executeSql('SELECT *FROM CART WHERE store_id=?',[store_name],function(tx,data) {   
                ...
                $('#total_qty,#total_qty2').text(total_qty);
                $('#total_price,#total_price2').text(total_price);   
            });
        //});
    });
  }
...
<div class="container">\
    <div class="d-flex align-items-end">\
        ...
        <h4 class="mb-2">'+app_name+'</h4>\
            ...
            <div class="text-dark ps-3"><i class="bi-geo-alt-fill"></i> '+address+'-441107</div>\
        </div>\
        ...
        <div class="destination ms-auto d-flex align-items-center">\
        <a href="'+base_url+store_name+'/cart" class="text-dark text-decoration-none home-cart-btn me-4">\
                        <div class="d-flex align-items-center ps-3">\
                            <div class="cart position-relative">\
                                <i class="bi-cart4"></i>\
                                <div class="badge bg-danger" id="total_qty2">0</div>\
                            </div>\
                            <div class="ms-3">\
                                <small class="text-muted">My Cart</small>\
                                <h6 id="total_price2">₹ 00.00</h6>\
                            </div>\
                        </div>\
                    </a>\
                    <a href="#" class="d-flex align-items-center text-decoration-none text-dark lh-1">\
                        <i class="bi-person-circle me-2 font-20"></i> Account</a>\
                    </div>\
    </div>\
</div>\
</div>';
